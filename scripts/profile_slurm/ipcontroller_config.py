...
#------------------------------------------------------------------------------
#  See also: BaseIPythonApplication.add_ipython_dir_to_sys_path
# c.IPController.add_ipython_dir_to_sys_path = False
...
## ssh url for engines to use when connecting to the Controller
...
## DEPRECATED: use ports
#  Default: None
# c.IPController.hb = None

## DEPRECATED: use ports
#  Default: None
# c.IPController.iopub = None
...
#  Default: 'ip-10-0-150-39'
# c.IPController.location = 'ip-10-0-150-39'
...
## Whether to reuse existing json connection files.
...
## ssh url for clients to use when connecting to the Controller
#          processes. It should be of the form: [user@]server[:port]. The
#          Controller's listening addresses must be accessible from the ssh server
#  Default: ''
...
# c.IPController.work_dir = '/home/ubuntu'
...
## select the task scheduler scheme  [default: Python LRU]
...
## The directory containing the sqlite task database.  The default
